...
use App\Services\Landlord\OAuth\FacebookOAuthService;
...
class FacebookController extends Controller
{
    ...
    {
        $url = Socialite::driver(ExternalPlatformEnum::FACEBOOK->value)
    ...
    public function callback(Request $request)
    {
        ...
        try {
            ...
            $payload = $this->facebookOauthService->handle(tenant_id: $tenant_id, fb_code: $code);
