...
class Subscription extends BaseLandlordModel
{
    ...
    protected $fillable = [
        'plan_id', 'tenant_id', 'monthly_credit_tokens',
        'status', 'starts_at', 'ends_at', 'trial_ends_at', 'is_trial',
        'auto_renew', 'plan_snapshot', 'cancelled_at', 'amount', 'currency', 'billing_cycle',
    ];
